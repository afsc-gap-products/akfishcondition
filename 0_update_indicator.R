...
# EBS_INDICATOR$STRATUM <- dplyr::rename(EBS_INDICATOR$STRATUM, stratum = area_id)
# NBS_INDICATOR$STRATUM <- dplyr::rename(NBS_INDICATOR$STRATUM, stratum = area_id)
# GOA_INDICATOR$STRATUM <- dplyr::rename(GOA_INDICATOR$STRATUM, rep_area = area_id)
# AI_INDICATOR$STRATUM <- dplyr::rename(AI_INDICATOR$STRATUM, inpfc_area = area_id)
...
print(range(akfishcondition::AI_INDICATOR$FULL_REGION$year))
print(range(akfishcondition::GOA_INDICATOR$FULL_REGION$year))
print(range(akfishcondition::EBS_INDICATOR$FULL_REGION$year))
print(range(akfishcondition::NBS_INDICATOR$FULL_REGION$year))
