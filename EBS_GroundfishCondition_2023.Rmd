...
Insert text here to talk about the trends in figure 3. Or maybe just talk about it in the previous text chunk and have the two figures come one after another?
...
In 2021, negative length-weight residuals were observed for large walleye pollock (>250 mm), Pacific cod, yellowfin sole, and Alaska plaice in the NBS (Figure 4). The only species with a positive length-weight residual in the NBS in 2021 was small walleye pollock (100-250 mm) (Figure 4).
...
Insert text here to talk about the trends in figure 5. Or maybe just talk about it in the previous text chunk and have the two figures come one after another?
