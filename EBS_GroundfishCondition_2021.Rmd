...
ebs_ann_mean_resid_df$DISPLAY_NAME <- set_plot_order(nbs_ann_mean_resid_df$COMMON_NAME, REGION = "BS")
...
```{r figure 4 grid, include=TRUE, echo=FALSE, fig.height=14, fig.width=12, fig.cap="\\label{fig:figs}Figure 4. Length-weight residuals by survey stratum (10-60) for seven eastern Bering Sea shelf groundfish species and age 1–2 walleye pollock (100–250 mm) sampled in the AFSC/RACE GAP standard summer bottom trawl survey, 1999-2019. Length-weight residuals are not weighted by stratum biomass.",message=FALSE, warning=FALSE}
print(fig4)
```
