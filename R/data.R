...
#' Arrowtooth flounder Ecosystem and Socioeconomic Profile (ESP) indicator
#' 
#' Morphometric condition indicators based on residuals from a length-weight regression for adult arrowtooth flounder. Separate indicator for each region.
#' 
#' @format Eight data frames (indicator for the full region and indicator by stratum for the GOA) and a character vector.
#' \describe{
#'      \itemize{
#'        \item FULL_REGION_* (data frame): Residuals for the full region
#'          \itemize{
...
#' 
#' @format Eight data frames (indicator for the full region and indicator by stratum for the EBS) and a character vector.
#' \describe{
#'      \itemize{
#'        \item FULL_REGION_* (data frame): Residuals for the full region
#'          \itemize{
