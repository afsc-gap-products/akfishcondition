...
EBS_INDICATOR <- list(FULL_AREA = as.data.frame(ebs_ann_mean_resid_df),
                      STRATUM = as.data.frame(ebs_stratum_resids),
                      LAST_UPDATE = Sys.Date())
NBS_INDICATOR <- list(FULL_AREA = as.data.frame(nbs_ann_mean_resid_df),
                      STRATUM = NA,
                      LAST_UPDATE = Sys.Date())
GOA_INDICATOR <- list(FULL_AREA = as.data.frame(goa_ann_mean_resid_df),
                      STRATUM = as.data.frame(goa_stratum_resids),
                      LAST_UPDATE = Sys.Date())
AI_INDICATOR <- list(FULL_AREA = as.data.frame(ai_ann_mean_resid_df),
