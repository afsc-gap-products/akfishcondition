...
ESR_SETTINGS <- list(ESR_SPECIES = data.frame(common_name = c(
    ...
    AI = c(FALSE, TRUE, TRUE, TRUE, FALSE, FALSE, TRUE, TRUE, FALSE, FALSE, FALSE, TRUE, FALSE, TRUE, FALSE, TRUE),
    GOA = c(TRUE, TRUE, TRUE, TRUE, FALSE, FALSE, FALSE, TRUE, FALSE, FALSE, FALSE, TRUE, FALSE, TRUE, TRUE, TRUE),
    EBS = c(FALSE, TRUE, TRUE, TRUE, FALSE, FALSE, FALSE, TRUE, TRUE, TRUE, TRUE, FALSE, TRUE, FALSE, FALSE, FALSE),
    NBS = c(FALSE, TRUE, TRUE, TRUE, FALSE, FALSE, FALSE, FALSE, FALSE, TRUE, FALSE, FALSE, TRUE, FALSE, FALSE, FALSE)),
...
EBS_INDICATOR <- list(
  FULL_REGION = as.data.frame(
    dplyr::full_join(ebs_sbw$full_sbw,
      ebs_vast_df)) %>%
...
NBS_INDICATOR <- list(
  FULL_REGION = as.data.frame(
    dplyr::full_join(nbs_sbw$full_sbw,
                           nbs_vast_df) %>% 
      dplyr::filter( 
...
AI_INDICATOR <- list(
  FULL_REGION = as.data.frame(
    dplyr::full_join(ai_sbw$full_sbw,
      ai_vast_df)) %>%
...
PCOD_ESP <- list(
  FULL_REGION_EBS = as.data.frame(
    dplyr::filter(
      ebs_sbw$full_sbw, common_name %in% ESP_SETTINGS$ESP_SPECIES$common_name
    )),
  FULL_REGION_GOA = as.data.frame(
    dplyr::filter(
      goa_sbw$full_sbw, common_name %in% ESP_SETTINGS$ESP_SPECIES$common_name
    )),
  FULL_REGION_AI = as.data.frame(
    dplyr::filter(
      ai_sbw$full_sbw, common_name %in% ESP_SETTINGS$ESP_SPECIES$common_name
    )),
