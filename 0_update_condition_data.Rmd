...
make_data_summary(dat_csv = here::here("data", "nbs_all_species.csv"), region = "NBS")
make_data_summary(dat_csv = here::here("data", "ebs_all_species.csv"), region = "EBS")
make_data_summary(dat_csv = here::here("data", "ai_all_species.csv"), region = "AI")
make_data_summary(dat_csv = here::here("data", "goa_all_species.csv"), region = "GOA")
```
...
# Aleutian Islands
ai_biomass <- read.csv(file = here::here("data", "stratum_biomass_ai_all_species.csv"))

ai_lw <- read.csv(file = here::here("data", "gcd_ai_all_species.csv")) %>%
...
goa_lw <- read.csv(file = here::here("data", "gcd_goa_all_species.csv")) %>%
                dplyr::filter(!is.na(length_mm)) %>%
                dplyr::mutate(ID = paste(cruise, vessel, haul, specimenid, sep = "_"))
...
ebs_lw <- read.csv(file = here::here("data", "gcd_ebs_all_species.csv")) %>%
...
nbs_dat <- read.csv(file = here::here("data", "gcd_nbs_all_species.csv")) %>%
  dplyr::filter(!is.na(length_mm)) %>%
