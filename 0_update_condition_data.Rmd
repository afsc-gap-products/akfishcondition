...
print(akfishcondition::AI_dat$LAST_UPDATE)
print(akfishcondition::GOA_dat$LAST_UPDATE)
print(akfishcondition::EBS_dat$LAST_UPDATE)
print(akfishcondition::NBS_dat$LAST_UPDATE)
```