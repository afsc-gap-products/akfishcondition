...
Contributed by Bianca Prohaska^1^, Sean Rohan^1^, and Cecilia O'Leary^1^
...
fig2  <- plot_anomaly_timeseries(x = EBS_INDICATOR$FULL_REGION,
                        region = "BS",
                        fill_color = "#0085CA",
                        var_y_name = "vast_condition",
                        var_y_se_name = "vast_condition_se",
                        var_x_name = "year",
                        y_title = expression("VAST Condition "~((grams/cm)^beta)),
                        format_for = "rmd")
...
png(here::here("plots", region, "EBS_condition.png"),width=6,height=7,units="in",res=300)
...
fig3 <- plot_two_timeseries(x_1 = akfishcondition::EBS_INDICATOR$FULL_REGION,
                                ...
                                region = "BS",
                                series_name_1 = "SBW (Historical)",
                                series_name_2 = "VAST (New)",
                                var_y_name_1 = "mean_wt_resid",
                                var_x_name_1 = "year",
                                var_y_name_2 = "vast_condition",
                                var_x_name_2 = "year",
                                y_title = "Condition anomaly (Z-score)",
                                scale_y = TRUE,
                                year_break = 2020,
                                fill_colors = c("#0085CA", "#001743"),
                                format_for = "rmd")
...
png(here::here("plots", region, "EBS_VAST_HISTORICAL_timeseries.png"),width=6,height=7,units="in",res=300)
print(fig3_png + theme_blue_strip())
dev.off()
```
...
fig4 <- akfishcondition::plot_xy_corr(
  ...
  x_2 = akfishcondition::EBS_INDICATOR$FULL_REGION,
  region = region,
  series_name_1 = "Stratum-biomass-weighted (Historical)",
  series_name_2 = "VAST (New)",
  var_y_name_1 = "mean_wt_resid",
  var_y_se_name_1 = "se_wt_resid",
  var_x_name_1 = "year",
  var_y_name_2 = "vast_condition",
  var_y_se_name_2 = "vast_condition_se",
  var_x_name_2 = "year",
  format_for = "rmd")
...
```{r figure 4 grid, include=TRUE, echo=FALSE, fig.height=14, fig.width=12, fig.cap="\\label{fig:figs}Figure 4. Stratum-biomass weighted (SBW) condition based on length-weight residuals versus VAST condition for the northern Bering Sea. Points denote the mean, error bars denote two standard errors.",message=FALSE, warning=FALSE}
print(fig4 +
  theme_condition_index())
```

```{r figure 4 grid png, include=FALSE, echo=FALSE, message=FALSE, warning=FALSE}
png(here::here("plots", region, "EBS_VAST_VS_HISTORICAL_scatterplot.png"), width = 6, height = 7, units = "in", res = 600)
...
png(here::here("plots", region, "NBS_condition.png"), width=6, height=7, units="in", res=300)
...
fig6_png <- akfishcondition::plot_two_timeseries(
  x_1 = akfishcondition::NBS_INDICATOR$FULL_REGION,
  x_2 = akfishcondition::NBS_INDICATOR$FULL_REGION,
  region = region,
  series_name_1 = "Mean residual (Historical)",
...
```{r figure 6 grid, include=TRUE, echo=FALSE, fig.height=14, fig.width=12, fig.cap="\\label{fig:figs}Figure 4. Length-weight residuals by survey stratum (10-60) for seven eastern Bering Sea shelf groundfish species and age 1–2 walleye pollock (100–250 mm) sampled in the AFSC/RACE GAP standard summer bottom trawl survey, 1999-2021. Length-weight residuals are not weighted by stratum biomass.",message=FALSE, warning=FALSE}
print(fig6 +
  theme_condition_index())
```

```{r figure 6 grid png, include=FALSE, echo=FALSE, message=FALSE, warning=FALSE}
png(here::here("plots", region, "NBS_VAST_VS_HISTORICAL_timeseries.png"), width = 6, height = 7, units = "in", res = 600)
...
```{r figure 7 grid, include=TRUE, echo=FALSE, fig.height=14, fig.width=12, fig.cap="\\label{fig:figs}Figure 4. Stratum-biomass weighted (SBW) condition based on length-weight residuals versus VAST condition for the northern Bering Sea. Points denote the mean, error bars denote two standard errors.",message=FALSE, warning=FALSE}
print(fig7 +
  theme_condition_index())
```

```{r figure 7 grid png, include=FALSE, echo=FALSE, message=FALSE, warning=FALSE}
png(here::here("plots", region, "NBS_VAST_VS_HISTORICAL_scatterplot.png"), width = 6, height = 7, units = "in", res = 600)
...
print(ebs_stacked_bar + akfishcondition::theme_blue_strip())
dev.off()
