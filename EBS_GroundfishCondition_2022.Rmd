...
# Load data
ebs_ann_mean_resid_df <- EBS_INDICATOR$FULL_REGION
ebs_stratum_resids_df <- EBS_INDICATOR$STRATUM
nbs_ann_mean_resid_df <- NBS_INDICATOR$FULL_REGION
...
```{r newfigure 3 grid png, include=FALSE, echo=FALSE, message=FALSE, warning=FALSE}
...
```{r oldfigure 3 grid, include=FALSE, echo=FALSE, message=FALSE, warning=FALSE}
print(fig3 + theme_condition_index())

fig3 <- plot_anomaly_timeseries(x = NBS_INDICATOR$FULL_REGION,
                        region = "BS", 
                        fill_color = "#0085CA", 
...
fig3_png <- plot_anomaly_timeseries(x = NBS_INDICATOR$FULL_REGION,
                        region = "BS", 
                        fill_color = "#0085CA", 
                        var_y_name = "mean_resid", 
                        var_y_se_name = "se",
...
fig4_new <- plot_xy_corr(
  ...
  region = "BS",
  series_name_1 = expression("Stratum-biomass weighted residual "~(ln(grams))),
  series_name_2 = expression("VAST Condition "~((grams/cm)^beta)),
  var_y_name_1 = "mean_wt_resid",
...
fig4 <- plot_stratum_stacked_bar(x = EBS_INDICATOR$STRATUM,
                                 region = "BS",
                                 fill_palette = "BrBG",
...
png(here::here("plots", "EBS_VAST_VS_HISTORICAL_Scatterplot.png"), width = 6, height = 7, units = "in", res = 300)
