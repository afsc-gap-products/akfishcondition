...
png(here::here("plots", region, "AI_condition.png"),width=6,height=7,units="in",res=300)
...
png(here::here("plots", region, "AI_VAST_HISTORICAL_timeseries.png"),width=6,height=7,units="in",res=300)
...
png(here::here("plots", region, "AI_VAST_VS_HISTORICAL_scatterplot.png"), width = 6, height = 7, units = "in", res = 600)
