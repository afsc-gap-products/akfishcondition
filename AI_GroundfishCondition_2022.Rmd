...
```{r figure 3 grid, include = TRUE, echo = FALSE, fig.height = 14, fig.width = 12, fig.cap = "\\label{fig:figs}Figure 2. Biomass-weighted residual body condition index across survey years (1984--2018) for seven Aleutian Islands groundfish species collected on the National Marine Fisheries Service (NMFS) Alaska Fisheries Science Center (AFSC) Resource Assessment and Conservation Engineering Groundfish Assessment Program (RACE-GAP) standard summer bottom trawl survey. Filled bars denote weighted length-weight residuals using this year's indicator calculation, error bars denote two standard errors, points denote the mean of the unweighted length-weight residual from the previous year's (2018) ESR.",  message = FALSE, warning = FALSE}
fig3 <- akfishcondition::plot_two_timeseries(x_1 = akfishcondition::AI_INDICATOR$FULL_REGION,
...
fig3_png <- akfishcondition::plot_two_timeseries(x_1 = akfishcondition::AI_INDICATOR$FULL_REGION,
  x_2 = akfishcondition::AI_INDICATOR$FULL_REGION,
  region = region,
  series_name_1 = "SBW (Historical)",
  series_name_2 = "VAST",
...
print(fig3 + theme_condition_index() + theme(legend.position = "bottom"))
```

```{r figure 3 grid png, include=FALSE, echo=FALSE, message=FALSE, warning=FALSE}
png(here::here("plots", "AI_SBW_vs_VAST_timeseries.png"), width = 6, height = 7, units = "in", res = 300)
...
```{r figure 4 grid, include = TRUE, echo = FALSE, fig.height = 14, fig.width = 12, fig.cap = "\\label{fig:figs}Figure 3. Residual body condition index for seven Aleutian Islands groundfish species collected on the National Marine Fisheries Service (NMFS) Alaska Fisheries Science Center (AFSC) Resource Assessment and Conservation Engineering Groundfish Assessment Program (RACE-GAP) standard summer bottom trawl survey (1984--2018) grouped by International North Pacific Fisheries Commission (INPFC) statistical sampling strata.", message = FALSE, warning = FALSE}
fig4_new <- plot_xy_corr(
  x_1 = akfishcondition::AI_INDICATOR$FULL_REGION,
  x_2 = akfishcondition::AI_INDICATOR$FULL_REGION,
  region = region,
  series_name_1 = "Stratum-biomass weighted residual",
  series_name_2 = "VAST",
  var_y_name_1 = "mean_wt_resid",
...
fig4 <- plot_stratum_stacked_bar(x = AI_INDICATOR$STRATUM,
                                 region = region,
                                 fill_palette = "BrBG",
...
print(fig4_new + theme_condition_index())
```
...
print(fig4 + theme_blue_strip())
dev.off()

png(here::here("plots", "AI_VAST_VS_SBW.png"),width=6,height=7,units="in",res=300)
print(fig4_new_png + theme_blue_strip())
dev.off()
