...
png(here::here("plots", "GOAbyyear_1.png"),width=6,height=7,units="in",res=300)
print(fig2a_png + theme_blue_strip())
dev.off()

png(here::here("plots", "GOAbyyear_2.png"),width=6,height=7,units="in",res=300)
...
png(here::here("plots", "GOA_condition_by_stratum_1.png") ,width=6,height=7,units="in",res=300)
print(fig3a + theme_blue_strip())
dev.off()

png(here::here("plots", "GOA_condition_by_stratum_2.png") ,width=6,height=7,units="in",res=300)
